...
for(k in 1:3) {
  ...
  data$logodds = data$b0 + data$b1*data$t + data$b2*data$Y1 + data$u1*data$t + data$u0  
  data$probability = logistic(data$logodds)
  ...
  data$logodds = data$b0 + data$b1*data$t + data$b2*data$Y2 + data$u1*data$t + data$u0  
  data$probability = logistic(data$logodds)
...
out.file2 = "D:/King_Abdullah/MBN_INLA2/output_file.rds"
saveRDS(stats, file = out.file2)
#readRDS("D:/King_Abdullah/MBN_INLA2/output_file.rds")
