...
#====Simulation study for m by m correlated RE with different priors=====#
...
for(k in 1:nsims) {
  ...
  data <- data[, !(names(data) %in% c("u0","u1", "e", "b0","b0i", "b1i", "b1", "logodds", "probability"))]
  ...
  data$Y5 = data$b0 + data$b1*data$Y2 + data$u1*data$Y2 + data$u0 + data$e
  ...
  data$Y6 = data$b0 + data$b1*data$Y1 +data$b2*data$Y5 + data$u1*data$Y1 + 
    data$u2*data$Y5 + data$u0 + data$e
  ...
  data$Y7 = data$b0 + data$b1*data$Y5 +data$b2*data$Y6 + data$u1*data$Y5 + 
    data$u2*data$Y6 + data$u0 + data$e
  ...
  data$b0 = 0.75
  data$Y8 = data$b0 +  data$u0 + data$e
  ...
  data$Y9 = data$b0 + data$b1*data$Y1 +data$b2*data$Y4 +data$b3*data$Y8 + 
    data$u1*data$Y1 + data$u2*data$Y4 + data$u3*data$Y8 + 
    data$u0 + data$e
  ...
  data$Y10 = data$b0 + data$b1*data$Y4 +data$b2*data$Y6 + data$u1*data$Y4 + 
    data$u2*data$Y6 + data$u0 + data$e
  
  data <- data[, !(names(data) %in% c("u0","u1","u2", "e", "b0","b0i", "b1i", "b1", "b2i", "b2", "ID"))]
